    ...
    <>
      <div className="bg-image w-screen h-screen flex flex-col items-center">{/*header*/}
        <section className="flex w-full flex-col py-12 space-y-12 items-center text-center">
          ...
          <span className="text-2xl bg-gradient-to-r from-violet-800 via-yellow-700 to-red-600 inline-block text-transparent bg-clip-text font-bold">SUBRACTION PRACTICE</span>
        </section>
        <div className="flex flex-col items-center justify-center h-3/5 w-4/5 bg-slate-100 border-4 border-amber-400 font-sans italic">
          {answerSubmitted === false &&
            <div className="flex flex-col items-center justify-center space-y-4">
              <p className="text-3xl font-bold">What is the difference of <span className="text-orange-600">{num1}</span> and <span className="text-orange-600">{num2}</span>?</p>
