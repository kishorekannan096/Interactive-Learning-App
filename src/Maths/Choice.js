        ...
        <div className="bg-image w-screen h-screen">
          ...
          <section className="flex flex-col items-center space-y-10">
             <div className="flex flex-row h-40 space-x-44">
                <div className="flex flex-row justify-center pt-3 space-x-5 w-96 h-40 rounded-xl border-4 border-amber-400 shadow-xl font-bold text-3xl text-black">
                    {/* <img className="h-32 w-32" src={add} alt="addition"/> */}
                    <div className='pt-10'>
                      <button className='rounded-xl bg-amber-400 w-44 h-12' onClick={()=>{navigate(`/AddMain`)}}>ADDITION</button>
                    </div>
                </div>
                <div className="flex flex-row justify-center pt-3 space-x-3 w-96 h-40 rounded-xl border-4 border-amber-400 shadow-xl font-bold text-3xl text-black">
                    {/* <img className="h-32 w-32" src={subract} alt="subract"/> */}
                    <div className='pt-10'>
                      <button className='rounded-xl bg-amber-400 w-52 h-12' onClick={()=>{navigate(`/SubMain`)}}>SUBRACTION</button>
                    </div>
                </div>
             </div>
             <div className="flex flex-row h- space-x-44">
                <div className="flex flex-row justify-center pt-3 space-x-7 w-96 h-40 rounded-xl border-4 border-amber-400 shadow-xl font-bold text-3xl text-black">
                    {/* <img className="h-32 w-32" src={multiply} alt="multiply"/> */}
                    <div className='pt-10'>
                       <button className='rounded-xl bg-amber-400 w-40 h-12' onClick={()=>{navigate(`/Mulmain`)}}>MULTIPLY</button>
                    </div>
                </div>
                <div className="flex flex-row justify-center pt-3 space-x-7 w-96 h-40 rounded-xl border-4 border-amber-400 shadow-xl font-bold text-3xl text-black">
                    {/* <img className="h-32 w-32" src={division} alt="division"/> */}
                    <div className='pt-10'>
                       <button className='rounded-xl bg-amber-400 w-40 h-12' onClick={()=>{navigate(`/Divmain`)}}>DIVISION</button>
                    </div>
                </div>
             </div>
          </section>
